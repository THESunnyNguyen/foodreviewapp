...
<body>
    ...
    <div class="container">
        ...
        <a href="add-follower.php" class="login-btn">Add Follower</a>
        <a href="follower-list.php" class="login-btn">View Followers</a>
        <a href="update-following.php" class="login-btn">Update Super Follow</a>
        <a href="delete-follower.php" class="login-btn">Delete Followers</a>
    </div>
