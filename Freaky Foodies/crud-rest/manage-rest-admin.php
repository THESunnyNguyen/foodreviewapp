...
<html>
<head>
    <title>Restaurant Actions</title>
    <style>
        body, html {
...
<body>
    ...
    <div class="container">
        <h1>Restaurant Actions</h1>
        <a href="add-restaurant.php" class="login-btn">Add Restaurant</a>
        <a href="restaurant-list.php" class="login-btn">View Restaurant</a>
        <a href="update-restaurant.php" class="login-btn">Update Restaurant</a>
        <a href="delete-restaurant.php" class="login-btn">Delete Restaurant</a>
    </div>
