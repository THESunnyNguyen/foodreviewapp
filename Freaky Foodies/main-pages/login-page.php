...
<body>
    <div class="navbar">
        <?php
            include '../miscellaneous/navbar.php';
        ?>
    </div>

    <div class="container">
        <h1>Login</h1>
        <a href="../login-pages/admin-login.php" class="login-btn">Admin Login</a>
        <a href="../login-pages/user-login.php" class="login-btn">User Login</a>
        <a href="../login-pages/restaurant-login.php" class="login-btn">Restaurant Login</a>
        <a href="../account-creation/create-accounts.php" class="login-btn">Create Account</a>
    </div>
