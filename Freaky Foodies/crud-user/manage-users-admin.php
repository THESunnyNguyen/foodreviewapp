...
<body>
    ...
    <div class="container">
        <h1>User Actions</h1>
        <a href="add-user.php" class="login-btn">Add User</a>
        <a href="user-list.php" class="login-btn">View User</a>
        <a href="update-user.php" class="login-btn">Update User</a>
        <a href="delete-user.php" class="login-btn">Delete User</a>
    </div>
